...
_"How do most closed source SaaS figure out a way to prioritize security ... "_ - they prioritize it only so much that a) it does not affect their reputation too much (if competition exists), b) to limit their own operations costs (bugs can be costly for the provider too) c) that security is not so bad that the customer might sue for gross negligence (which might be a way to sue around the limited liability in the terms and conditions of the SaaS) and d) there can be compliance requirements (like FedRAMP, C5:2025, ISO 27k1, ....)
Nguồn:: [Is a closed source SaaS more secured, especially when the team is overwhelmed?](https://security.stackexchange.com/questions/286945/is-a-closed-source-saas-more-secured-especially-when-the-team-is-overwhelmed/286946?noredirect=1#comment598650_286946)